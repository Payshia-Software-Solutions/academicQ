...
const registerSchema = z.object({
  ...
  nic: z.string().min(10, { message: 'Please enter a valid NIC.' }),
});
...
export default function RegisterPage() {
  ...
  const onSubmit = async (data: RegisterFormValues) => {
    ...
    try {
      // These values seem to be handled by the server, sending what the user provides.
      const postData = {
        ...data,
        is_active: 1,
        created_by: null,
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="902345678V" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
